...
export const megaMenu = {
  ...
  "Others": {
    ...
    right: {
      "Calculator": [
        { label: "All Calculators", href: "/services/all-calculators" },
        { label: "Income Tax Calculator", href: "/services/income-tax-calculator" },
        { label: "HRA Calculator", href: "/services/hra-calculator" },
        { label: "GST Calculator", href: "/services/gst-calculator" },
        { label: "EMI Calculator", href: "/services/emi-calculator" },
        { label: "Home Loan EMI Calculator", href: "/services/home-loan-emi-calculator" },
        { label: "Salary Calculator", href: "/services/salary-calculator" },
        { label: "Mutual Fund Returns Calculator", href: "/services/mutual-fund-calculator" },
        { label: "Retirement Planning Calculator", href: "/services/retirement-calculator" },
        { label: "EPF Calculator", href: "/services/epf-calculator" },
        { label: "PPF Calculator", href: "/services/ppf-calculator" },
        { label: "NPS Calculator", href: "/services/nps-calculator" },
        { label: "Gratuity Calculator", href: "/services/gratuity-calculator" },
        { label: "Simple Compound Interest Calculator", href: "/services/interest-calculator" },
        { label: "FD Calculator", href: "/services/fd-calculator" },
        { label: "Lumpsum Calculator", href: "/services/lumpsum-calculator" },
        { label: "TDS Calculator", href: "/services/tds-calculator" },
        { label: "RD Calculator", href: "/services/rd-calculator" },
        { label: "SIP Calculator", href: "/services/sip-calculator" },
        { label: "Business Setup Calculator", href: "/services/business-setup-calculator" },
      ],
      "Fundraising": [
