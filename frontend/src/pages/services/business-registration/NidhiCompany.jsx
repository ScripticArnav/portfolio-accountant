    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-4xl font-bold text-slate-900 mb-4">Nidhi Company</h1>
          <p className="text-lg text-slate-600 mb-8">
            Professional Nidhi Company registration and compliance services for mutual benefit organizations.
          </p>

          <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-8 rounded">
            <h3 className="font-bold text-slate-900 mb-2">Why Choose Our Nidhi Company Services?</h3>
            <p className="text-slate-700">
              Expert guidance for Nidhi Company setup with comprehensive compliance support and professional assistance.
            </p>
          </div>
          ...
          <div className="bg-green-50 border border-green-200 p-6 rounded-lg mb-8">
            ...
            <ul className="text-slate-700 space-y-2">
              <li>✓ Mutual Benefit for Members</li>
              <li>✓ Regulated Financial Operations</li>
              <li>✓ Enhanced Trust & Credibility</li>
              <li>✓ Professional Compliance Framework</li>
            </ul>
          </div>
