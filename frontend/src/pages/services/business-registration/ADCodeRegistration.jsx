    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-4xl font-bold text-slate-900 mb-4">AD Code Registration</h1>
          <p className="text-lg text-slate-600 mb-8">
            Professional AD Code registration services for foreign exchange operations and international trade.
          </p>

          <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-8 rounded">
            <h3 className="font-bold text-slate-900 mb-2">Why Choose AD Code Registration?</h3>
            <p className="text-slate-700">
              Expert guidance for AD Code registration to facilitate foreign exchange operations.
            </p>
          </div>
          ...
          <div className="bg-green-50 border border-green-200 p-6 rounded-lg mb-8">
            ...
            <ul className="text-slate-700 space-y-2">
              <li>✓ Foreign Exchange Authority</li>
              <li>✓ International Trade Access</li>
              <li>✓ RBI Compliance</li>
              <li>✓ Easy Currency Operations</li>
          ...
          <div className="bg-yellow-50 border border-yellow-200 p-6 rounded-lg">
            ...
            <p className="text-slate-700 mb-4">
              Our experts are ready to assist you with AD Code registration.
            </p>
...
export default ADCodeRegistration;
