    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-4xl font-bold text-slate-900 mb-4">Trademark Practice & Consulting</h1>
          <p className="text-lg text-slate-600 mb-8">
            Professional trademark consulting and filing services.
          </p>

          <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-8 rounded">
            <h3 className="font-bold text-slate-900 mb-2">Why Choose Us?</h3>
            <p className="text-slate-700">
              Expert trademark support with complete filing assistance.
            </p>
          </div>
          ...
          <div className="bg-yellow-50 border border-yellow-200 p-6 rounded-lg">
            ...
            <p className="text-slate-700 mb-4">Protect your trademark!</p>
            <Link to="/Contact" className="px-6 py-3 bg-yellow-400 text-slate-900 font-bold rounded-lg hover:bg-yellow-300 transition-colors inline-block">Get Help Now
            </Link>
          </div>
        </div>
      </div>
...
export default TrademarkPractice;
