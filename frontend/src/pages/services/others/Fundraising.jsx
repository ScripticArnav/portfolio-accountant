    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-4xl font-bold text-slate-900 mb-4">Fundraising Services</h1>
          <p className="text-lg text-slate-600 mb-8">
            Comprehensive fundraising assistance for startups and businesses seeking capital investment.
          </p>

          <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-8 rounded">
            <h3 className="font-bold text-slate-900 mb-2">Why Choose Us?</h3>
            <p className="text-slate-700">
              Expert guidance in securing funding and connecting with investors.
            </p>
          </div>
          ...
          <div className="bg-green-50 border border-green-200 p-6 rounded-lg mb-8">
            ...
            <ul className="text-slate-700 space-y-2">
              <li>✓ Structured funding strategy</li>
          ...
          <div className="bg-yellow-50 border border-yellow-200 p-6 rounded-lg">
            ...
            <p className="text-slate-700 mb-4">Get fundraising assistance today.</p>
