      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <p className="text-lg text-slate-600 mb-8">
            Calculate Tax Deducted at Source (TDS) for various income categories and transactions.
          </p>

          <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-8 rounded">
            <h3 className="font-bold text-slate-900 mb-2">Why Use This Tool?</h3>
            <p className="text-slate-700">
              Accurate TDS calculation for compliance and financial planning.
            </p>
          </div>
          ...
          <div className="bg-green-50 border border-green-200 p-6 rounded-lg mb-8">
            ...
            <ul className="text-slate-700 space-y-2">
              <li>✓ Accurate TDS computation</li>
          ...
          <div className="bg-yellow-50 border border-yellow-200 p-6 rounded-lg">
            ...
            <p className="text-slate-700 mb-4">Calculate your TDS today.</p>
