      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <p className="text-lg text-slate-600 mb-8">
            Professional power of attorney documentation services for legal representation and authority delegation.
          </p>

          <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-8 rounded">
            <h3 className="font-bold text-slate-900 mb-2">Why Choose Power of Attorney Services?</h3>
            <p className="text-slate-700">
              Expert guidance for creating legally valid powers of attorney with proper documentation and registration.
            </p>
          </div>
          ...
          <div className="bg-green-50 border border-green-200 p-6 rounded-lg mb-8">
            ...
            <ul className="text-slate-700 space-y-2">
              <li>✓ Legal Authority Delegation</li>
              <li>✓ Proper Documentation</li>
              <li>✓ Notary Certification</li>
