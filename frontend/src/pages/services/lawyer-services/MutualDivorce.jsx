    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <Link to="/services/lawyer-services" className="flex items-center text-blue-600 hover:text-blue-700 mb-6">
          <ArrowLeft className="w-4 h-4 mr-2" /> Back to Lawyer Services
        </Link>

        <div className="bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-4xl font-bold text-slate-900 mb-4">Mutual Divorce</h1>
          <p className="text-lg text-slate-600 mb-8">
            Professional mutual divorce services for smooth and amicable separation.
          </p>

          <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-8 rounded">
            <h3 className="font-bold text-slate-900 mb-2">Why Choose Mutual Divorce Services?</h3>
            <p className="text-slate-700">
              Expert legal guidance for mutual divorce with complete agreement preparation and court proceedings.
            </p>
          </div>
          ...
          <div className="bg-green-50 border border-green-200 p-6 rounded-lg mb-8">
            ...
            <ul className="text-slate-700 space-y-2">
              <li>✓ Amicable Separation</li>
              <li>✓ Faster Divorce Process</li>
              <li>✓ Cost Effective</li>
              <li>✓ Fair Asset Division</li>
              <li>✓ Clear Legal Resolution</li>
            </ul>
          </div>
          ...
          <div className="bg-yellow-50 border border-yellow-200 p-6 rounded-lg">
            ...
            <p className="text-slate-700 mb-4">
              Our expert lawyers are ready to assist you with mutual divorce.
            </p>
