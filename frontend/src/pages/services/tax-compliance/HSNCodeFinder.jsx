    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-4xl font-bold text-slate-900 mb-4">HSN Code Finder</h1>
          <p className="text-lg text-slate-600 mb-8">
            Professional HSN code finder services for accurate product classification.
          </p>

          <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-8 rounded">
            <h3 className="font-bold text-slate-900 mb-2">Why Choose HSN Code Finder?</h3>
            <p className="text-slate-700">
              Expert guidance for HSN code classification and GST tax rate identification.
            </p>
          </div>
          ...
          <div className="bg-green-50 border border-green-200 p-6 rounded-lg mb-8">
            ...
            <ul className="text-slate-700 space-y-2">
              <li>✓ Accurate Classification</li>
              <li>✓ Correct Tax Rate</li>
              <li>✓ ITC Eligibility</li>
              <li>✓ Compliance Assurance</li>
              <li>✓ No GST Disputes</li>
            </ul>
          </div>
          ...
          <div className="bg-yellow-50 border border-yellow-200 p-6 rounded-lg">
            ...
            <p className="text-slate-700 mb-4">
              Our experts are ready to help with HSN code classification.
            </p>
